...
from data_bank.customer_nodes -- 5 
...
-- unique count of each transaction type 
...
-- In this analysis, we assume that the 1st condition is a customer who had made more than 1 deposit in any of the months, it is much less stringent as compared to a customer
-- that makes more than 1 deposit in each month. 
